...
public class ExcelCitac {
	...
	public void asertovanje(String sheetName, int rowNumber, int columnNumber, String actualText) {
		String expectedText = getStringData(sheetName, rowNumber, columnNumber); 
